...
\usepackage{calc}
\setlength{\topmargin}{-1in + 15pt}  % 页眉以上
\setlength{\headheight}{12pt}        % 页眉
\setlength{\headsep}{10pt}           % 页眉到正文
...
\lstinputlisting{code/computational_geometry/simpson.cpp}
...
% \lstinputlisting{code/curve_fit.cpp}
\section{Tips}
