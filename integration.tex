...
\paragraph{$\blacksquare$ 含有$ax+b$的积分($a \neq 0$)}
...
\paragraph{$\blacksquare$ 含有$\sqrt{ax+b}$的积分}
...
\paragraph{$\blacksquare$ 含有$x^2 \pm a^2$的积分}
...
\paragraph{$\blacksquare$ 含有$ax^2+b$($a>0$)的积分}
...
\paragraph{$\blacksquare$ 含有$ax^2+bx+c$($a>0$)的积分}
...
\paragraph{$\blacksquare$ 含有$\sqrt{x^2+a^2}$($a>0$)的积分}
...
\paragraph{$\blacksquare$ 含有$\sqrt{a^2-x^2}$($a>0$)的积分}
...
\paragraph{$\blacksquare$ 含有$\sqrt{\pm ax^2+bx+c}$($a>0$)的积分}
...
\paragraph{$\blacksquare$ 含有$\sqrt{\pm\frac{x-a}{x-b}}$或$\sqrt{(x-a)(x-b)}$的积分}
...
\paragraph{$\blacksquare$ 含有指数函数的积分}
...
\paragraph{$\blacksquare$ 含有对数函数的积分}
...
\paragraph{$\blacksquare$ 含有三角函数的积分}
...
\paragraph{$\blacksquare$ 含有反三角函数的积分(其中 $a>0$)}
